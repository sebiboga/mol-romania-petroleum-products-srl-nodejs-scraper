...
gh repo edit <owner>/<repo> \
  --description "web scraper pentru a aduce locurile de munca de la MOL Romania in platforma peviitor.ro"
...
# Topics
gh repo edit <owner>/<repo> \
  --add-topic scraper --add-topic mol --add-topic peviitor --add-topic jobs --add-topic romania
```
