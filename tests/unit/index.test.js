...
describe('index.js Component Tests', () => {
  ...
  describe('transformJobsForSOLR', () => {
    ...
    it('should keep company uppercase', () => {
      const payload = {
        ...
        cif: '7745470',
        jobs: [
          { url: 'https://test.com/1', title: 'Job 1', company: 'mol romania', cif: '7745470' }
        ]
      };
  ...
  describe('mapToJobModel', () => {
    it('should map raw job to job model format', () => {
      const rawJob = {
        url: 'https://molgroup.taleo.net/careersection/external/jobdetail.ftl?job=123',
      ...
      const COMPANY_NAME = 'MOL ROMANIA PETROLEUM PRODUCTS SRL';
    ...
    it('should remove undefined fields', () => {
      ...
      const result = index.mapToJobModel(rawJob, '7745470');
    ...
    it('should handle missing title', () => {
      ...
      expect(result.title).toBe('');  // null/undefined trimmed becomes empty string
